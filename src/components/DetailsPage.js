        ...
        return (
            <div class="container">
                <div id="detailspage"class="px2 py2 sm-py5 sm-px6 mx-auto sm-mb5 border-box card" role="main">
                    ...
                    <div id="printer"class="grid-row"><div class="grid-col-9"></div>
                        <div class="grid-col-3"><img class ="inline-block" src="assets/img/print.svg" width="17" height="17"/> <p class = "inline-block"> Print Page</p></div></div>
                    <h1 class="h3 my0">
