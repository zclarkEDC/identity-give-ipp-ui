...
class Results extends React.Component {
    ...
    constructor(props) {
        super(props);
        //const data = Array.from(props.item2);
        this.state = {
            //apidata: Array.from(props.item2),
    ...
    handleInputChange = event => {
      ...
      componentDidMount() {
        ...
        this.setState({actual_api_response: this.props.item2})
    ...
    render() {
        ...
        return (
            <div id="results" className="search-results">
                ...
                <p class='mt-tiny mb0'>
                    Results near postal code {this.props.item2}
                </p>
                <br></br>
