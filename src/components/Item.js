            ...
            <div>
                ...
                <div class="grid-row">
                    <div class="grid-col-8">
                        <p>{this.props.item.address}<br />{this.props.item.city}, {this.props.item.state} {this.props.item.postalCode}<br /><a href="url">{this.props.item.phone}</a></p></div><div class="grid-col-2"></div><div class="grid-col-2 text-right"><b>{Math.round(this.props.item.distance)} mi</b></div></div>
                <Link to={{
                    pathname: '/details',
